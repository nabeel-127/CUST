...
class CPAP(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label1.place(width = 292, x = 365, y = 300)
        #label1.pack(pady=10,padx=10)
        updateCPAP(label1)
