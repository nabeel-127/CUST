...
def updatePressure(label):
    def updatepressure():
        out = "Pressure: " + str(pressureList[10]) + " cmH2O"
...
def updateVC_label1a(label):
    def updateVC__label1a():
        ...
        out = str(VC_BPM)
        label.config(text = out)
        label.after(500, updateVC__label1a)
    updateVC__label1a()
def updateVC_label2a(label):
    def updateVC__label2a():
        ...
        out = str(VC_IE)
        label.config(text = out)
        label.after(500, updateVC__label2a)
    updateVC__label2a()
...
class volumeControl(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label1.place(height = 50, width = 300, x = 150, y = 120)
