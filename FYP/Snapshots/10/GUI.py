...
class mainFunc(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (AboutPage, StartPage, PageOne, PageTwo, PageThree, CPAP):
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button2 = tk.Button(self, text="", bg = bg_color_mainButton, fg = fg_color_mainButton, font = font_mainButton,
                            command=lambda: controller.show_frame(PageTwo))
