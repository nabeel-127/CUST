...
def updatePressure(label):
    def updatepressure():
        ...
        label.config(text = out)
        label.after(100, updatepressure)
    updatepressure()
...
def updateCPAP_label1(label):
    def updateCPAP__label1():
        ...
        label.config(text = out)
        label.after(100, updateCPAP__label1)
    updateCPAP__label1()
...
def updateVC_label1a(label):
    def updateVC__label1a():
        ...
        out = str(VC_BPM) + " bpm"
        label.config(text = out)
        label.after(100, updateVC__label1a)
    updateVC__label1a()
def updateVC_label2a(label):
    def updateVC__label2a():
        ...
        out = "1:" + str(VC_E)
        label.config(text = out)
        label.after(100, updateVC__label2a)
    updateVC__label2a()
