...
%ONE MATLAB code file for ONE.fig
...
%
%      ONE('Property','Value',...) creates a new ONE using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ONE_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      ONE('CALLBACK') and ONE('CALLBACK',hObject,...) call the
%      local function named CALLBACK in ONE.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 29-May-2019 11:00:21
